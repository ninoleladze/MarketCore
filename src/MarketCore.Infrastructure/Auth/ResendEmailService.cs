                      ...
                      <table cellpadding="0" cellspacing="0" border="0" style="margin:0 auto 36px;">
                        <tr>
                          <td style="background:#071428;border:1px solid #1c3868;border-top:2px solid #e87722;border-radius:14px;padding:28px 52px;text-align:center;">
                            ...
                            <p style="margin:0;font-size:46px;font-weight:800;letter-spacing:14px;color:#ff9a3c;font-family:'Courier New',Courier,monospace;line-height:1;">{verificationToken}</p>
                          </td>
                        </tr>
                      </table>
                      ...
                      <table cellpadding="0" cellspacing="0" border="0" style="margin:0 auto;">
                        <tr>
                          <td style="background:linear-gradient(135deg,#c45c00,#e87722);border-radius:999px;">
                            <a href="{clientBaseUrl}/orders/{orderId}" style="display:inline-block;padding:15px 44px;background:linear-gradient(135deg,#c45c00,#e87722);color:#fff;font-size:15px;font-weight:700;text-decoration:none;border-radius:999px;letter-spacing:0.02em;">View My Order</a>
                          </td>
                        </tr>
                      </table>
                    </td>
